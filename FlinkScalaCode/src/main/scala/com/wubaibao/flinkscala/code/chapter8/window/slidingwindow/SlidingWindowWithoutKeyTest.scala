package com.wubaibao.flinkscala.code.chapter8.window.slidingwindow
...
/**
 * Flink 基于EventTime SlidingWindow 滑动窗口测试
 * 案例：读取基站日志数据，每隔5s统计最近10s所有数据通话总时长。
 */
object SlidingWindowWithoutKeyTest {
  def main(args: Array[String]): Unit = {
    ...
    dsWithWatermark
      .windowAll(SlidingEventTimeWindows.of(Time.seconds(10), Time.seconds(3)))
